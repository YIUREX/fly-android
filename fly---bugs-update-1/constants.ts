...
import { PlaneModel, PlaneSkin, PowerUpType, TrailStyle, DeathEffectStyle, Achievement, BoostItem, BoostType, MusicTrack, Rarity, LeaderboardEntry, EpicRank } from './types';
...
export const EPIC_RANKS: EpicRank[] = [
  { level: 1, name: "Vuelo Cero", minScore: 0, color: "#8b4513", glowColor: "rgba(139, 69, 19, 0.3)" },
  { level: 2, name: "Ala de Recluta", minScore: 10000, color: "#cd7f32", glowColor: "rgba(205, 127, 50, 0.4)" },
  { level: 3, name: "Halcón de Papel", minScore: 50000, color: "#a0522d", glowColor: "rgba(160, 82, 45, 0.5)" },
  { level: 4, name: "Centinela del Viento", minScore: 150000, color: "#c0c0c0", glowColor: "rgba(192, 192, 192, 0.5)" },
  { level: 5, name: "Cruzado de las Nubes", minScore: 400000, color: "#e5e7eb", glowColor: "rgba(59, 130, 246, 0.6)" },
  { level: 6, name: "Soberano de la Altura", minScore: 800000, color: "#fbbf24", glowColor: "rgba(251, 191, 36, 0.6)" },
  { level: 7, name: "Comandante Astral", minScore: 1500000, color: "#f472b6", glowColor: "rgba(244, 114, 182, 0.7)" },
  { level: 8, name: "As de la Eternidad", minScore: 3000000, color: "#ffffff", glowColor: "rgba(255, 255, 255, 0.8)" },
  { level: 9, name: "Supremo de los Cielos", minScore: 6000000, color: "#a855f7", glowColor: "rgba(168, 85, 247, 0.9)" },
  { level: 10, name: "Deidad del Aire", minScore: 12000000, color: "#fbbf24", glowColor: "rgba(251, 191, 36, 1.0)" },
];
...
export const PLANE_SKINS: PlaneSkin[] = [
  ...
  // --- SECRET ---
  { id: 'legend_gold', name: 'Legenda Dorada', price: 0, rarity: Rarity.LEGENDARY, color: '#FFD700', secondaryColor: '#B8860B' },
];
...
export const TRAILS: TrailStyle[] = [
  ...
  // --- SECRET ---
  { id: 'gold_glitter', name: 'Brillo Leyenda', price: 0, rarity: Rarity.LEGENDARY, color: '#FFD700', widthScale: 1.3, glow: true, type: 'sparkle' },
];
...
export const ACHIEVEMENTS_LIST: Achievement[] = [
  ...
  { 
    ...
    description: 'Consigue 100.000 puntos (Desbloquea Skin Oro)', 
